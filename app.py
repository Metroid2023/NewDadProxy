        ...
        for event in events:
            ...
            for channel in channels_list:
                ...
                m3u_content += (
                    ...
                    '#EXTVLCOPT:http-user-agent=Mozilla/5.0 (iPhone; CPU iPhone OS 16_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.1 Mobile/15E148 Safari/604.1\n'
                    f'{proxy_url}\n\n'
                )
